-- Align create_project_from_paid_invoice with real tasks/workflow schema.
-- - tasks link uses related_project_id
-- - workflow source is product_workflow_steps by product_id
-- - no reminder_date/project_id usage
