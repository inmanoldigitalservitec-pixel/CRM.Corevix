-- Populate invoices.invoice_data when generating invoices from approved proposals.
-- Keeps existing behavior: avoid duplicates by reusing non-cancelled invoice.
...
begin
  ...
  if v_created_invoice then
    -- v_product_name may already be populated; ensure it exists for description.
