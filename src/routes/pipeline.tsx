    ...
    <div data-demo="pipeline-main" className="min-h-[calc(100vh-72px)] bg-white text-[#101828]">
      <div className="px-3 sm:px-4 lg:px-5 py-3">
        <div className="w-full min-w-0">
          ...
          <section className="mb-4 grid grid-cols-2 gap-x-4 gap-y-4 lg:grid-cols-5 lg:gap-x-8">
            <PipelineKpi
              label="Pipeline"
            ...
            <>
              {viewMode === "list" ? (
                <div className="overflow-hidden border-y border-slate-100 bg-white">
                  ...
                  <div className="grid grid-cols-[minmax(260px,1.5fr)_minmax(180px,1fr)_150px_120px_120px_130px] gap-3 border-b border-slate-100 bg-white px-4 py-2.5 text-[11px] font-normal uppercase text-slate-500 max-md:hidden">
                    <div>Oportunidad</div>
                    <div>Contacto</div>
                    <div>Etapa</div>
                    <div>Valor</div>
                      ...
                      .map((deal) => {
                        ...
                        return (
                          <button
                            key={deal.id}
                            type="button"
                            className="grid min-w-0 gap-3 rounded-lg border border-slate-200 bg-white p-3 text-left transition-colors active:scale-[0.992] hover:bg-slate-50/40"
                            onClick={() => setSelectedDeal(deal)}
                          >
                            <div className="flex min-w-0 items-start justify-between gap-3">
                              <div className="min-w-0">
                                <div className="truncate text-[14px] font-semibold text-[#101828]">
                                  {deal.name}
                                </div>
                            ...
                            <div className="grid grid-cols-2 gap-3 text-[12px]">
                              <div className="min-w-0">
                                <div className="uppercase text-[10px] text-[#98a2b3]">Valor</div>
                                <div className="mt-1 truncate font-semibold text-[#101828]">
                                  {moneyDeal(deal)}
                                </div>
                              </div>
                              <div className="min-w-0">
                                <div className="uppercase text-[10px] text-[#98a2b3]">Cierre</div>
                                <div className="mt-1 truncate text-[#475467]">
                                  {deal.expected_close
                  ...
                  <div className="max-h-[calc(100vh-280px)] overflow-y-auto max-md:hidden">
                    {deals
                      .filter((deal) => dealMatchesFilters(deal))
                      .sort((a, b) => {
