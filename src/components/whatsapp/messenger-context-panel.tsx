    ...
    <aside className={cn("min-h-0 border-l border-black/10 bg-[#f0f2f5] overflow-y-auto p-4", className)}>
      <div className="space-y-3">
        <div className="rounded-2xl border border-black/5 bg-white px-4 py-4 shadow-sm">
          ...
          <h3 className="mt-1 text-[18px] font-semibold tracking-[-0.03em] text-slate-900">Messenger</h3>
          <p className="mt-1 text-sm text-slate-500">Puedes responder por Messenger desde la bandeja.</p>
        </div>
        ...
        <div className="grid gap-3">
          ...
          <Field label="Canal" value={conversation?.platform === "messenger" ? "Messenger" : conversation?.platform || null} />
