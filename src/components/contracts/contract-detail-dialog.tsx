...
type ContractDocument = { id: string; file_name: string; file_url: string; file_type: string | null; file_size: number | null; created_at: string };
type ContractActivity = { id: string; action: string; detail: string | null; created_at: string; actor_profile_id: string | null };
